              ...
              <v-card color="#ffff" v-if="product">
                <div class="d-flex flex-no-wrap justify-space-between w-50 ga-15">
                  ...
                  <div>
                    ...
                    <v-card-subtitle class="text-wrap"> <p>{{ product.description }}</p></v-card-subtitle>
                    <v-card-subtitle><p><b>{{ product.category }} </b></p></v-card-subtitle>
                    <v-card-subtitle><p><b>rating : {{ product.rating.rate }}</b></p></v-card-subtitle>
                    <v-card-subtitle><p><b>stock : {{ product.rating.count }}</b></p></v-card-subtitle>
